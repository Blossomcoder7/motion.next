  ...
  return (
    <ClickAwayListener onClickAway={() => setOpen(false)}>
      <motion.div
        ...
        ref={wrapperRef}
        className="w-full fixed bottom-4 z-[9999]  mx-auto  transition-all duration-200 ease-in cursor-pointer  rounded-2xl overflow-hidden"
      >
        <div className="w-full max-w-[680px] flex flex-col  rounded-2xl items-center text-white bg-[#171717] hover:backdrop-blur-[3px] backdrop-blur-[2px]  mx-auto justify-center">
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                className="w-full bg-[#171717]  rounded-2xl overflow-hidden"
              >
