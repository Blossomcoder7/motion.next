  ...
  return (
    <div className=" flex flex-col">
      <div className="w-full px-6">
        <div className="flex flex-col  w-full justify-between text-[10.42rem] font-bold uppercase">
          <div className="flex w-full justify-between">
            <p className="px-4">Work</p>
            <p>{"'"}25</p>
          </div>
          <div className="w-full flex gap-3 px-4">
            <div className="w-[50%] bg-black h-[95vh] rounded-2xl group overflow-hidden">
              <div className="h-[79vh] w-full p-5">
                <div className="relative h-full w-full rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute top-1/2 left-1/2 h-52 w-96 transform -translate-x-1/2 -translate-y-1/2 rounded-2xl opacity-0 scale-0 group-hover:opacity-100 group-hover:scale-100 group-hover:cursor-pointer transition-all duration-500 ease-in-out shadow-lg">
